...
void menu8TambahData()
{
    ...
    dataBaru.sex = _sex;
    dataBaru.age = _age;
    dataBaru.studytime = _studytime;
    dataBaru.absence = _absence;
    dataBaru.g1 = _g1;
    dataBaru.g2 = _g2;
    dataBaru.g3 = _g3;

    indexTerakhirTerisi++;
    daftarMahasiswa[indexTerakhirTerisi] = dataBaru;

    printf("1 Data berhasil ditambahkan, %c %d %d %d %d %d %d\n", dataBaru.sex, dataBaru.age, dataBaru.studytime, dataBaru.absence, dataBaru.g1, dataBaru.g2, dataBaru.g3);
}
...
void pilihanMenu()
{
    ...
    printf("> 8. Tambahkan data mahasiswa secara manual\n");
    printf("> 0. Keluar\n");
    printf(">> Pilih menu? ");
