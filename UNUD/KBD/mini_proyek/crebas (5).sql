/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     12/16/2019 8:28:44 PM                        */
/*==============================================================*/
...
(
   ...
   KAT_ID_KATEGORI_SAMPAH char(5)  comment '',
...
alter table DETAIL_TRANSAKSI_PEMBELIAN add constraint FK_DETAIL_T_RELATIONS_KATEGORI foreign key (KAT_ID_KATEGORI_SAMPAH)
      references KATEGORI_SAMPAH (ID_KATEGORI_SAMPAH) on delete restrict on update restrict;

alter table DETAIL_TRANSAKSI_PENGEPUL add constraint FK_DETAIL_T_RELATIONS_KATEGORI foreign key (KAT_ID_KATEGORI_SAMPAH)
      references KATEGORI_SAMPAH (ID_KATEGORI_SAMPAH) on delete restrict on update restrict;
...
alter table TRANSAKSI_PEMBELIAN add constraint FK_TRANSAKS_MELAKUKAN_PEGAWAI foreign key (ID_PEGAWAI)
      references PEGAWAI (ID_PEGAWAI) on delete restrict on update restrict;

alter table TRANSAKSI_PEMBELIAN add constraint FK_TRANSAKS_MENDETAIL_DETAIL_T foreign key (ID_DETAIL_PEMBELIAN)
      references DETAIL_TRANSAKSI_PEMBELIAN (ID_DETAIL_PEMBELIAN) on delete restrict on update restrict;

alter table TRANSAKSI_PENGEPULAN add constraint FK_TRANSAKS_MELAKUKAN_PEGAWAI foreign key (ID_PEGAWAI)
      references PEGAWAI (ID_PEGAWAI) on delete restrict on update restrict;

alter table TRANSAKSI_PENGEPULAN add constraint FK_TRANSAKS_MENDETAIL_DETAIL_T foreign key (ID_DETAIL_PENGEPULAN)
