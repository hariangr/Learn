/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     12/16/2019 8:42:05 PM                        */
/*==============================================================*/
...
(
   ...
   ID_KATEGORI_SAMPAH   char(5)  comment '',
   ID_SAMPAH_PENGEPUL   char(5) not null  comment '',
...
alter table DETAIL_TRANSAKSI_PEMBELIAN add constraint FK_DETAIL_T_MENDETAIL_KATEGORI foreign key (ID_KATEGORI_SAMPAH)
      references KATEGORI_SAMPAH (ID_KATEGORI_SAMPAH) on delete restrict on update restrict;

alter table DETAIL_TRANSAKSI_PENGEPUL add constraint FK_DETAIL_T_MENDETAIL_KATEGORI foreign key (ID_KATEGORI_SAMPAH)
      references KATEGORI_SAMPAH (ID_KATEGORI_SAMPAH) on delete restrict on update restrict;
